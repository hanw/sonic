...
#define SONIC_MPRINT(pointer, msg, args...)
#endif /* SONIC_DMEMORY */
#define DISABLE_INTERRUPT(flags) flags=!flags
...
#define START_CLOCK_INTR()  CLOCK(_t1); flags=1;
...
/* arp.c */
int sonic_mac_arp_loop(void *);

/* availbw.c */
int sonic_app_availbw_loop(void *);
...
int sonic_fill_buf_batching(struct sonic_port_info *, struct sonic_packets *, int );
