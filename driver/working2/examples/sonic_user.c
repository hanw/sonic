...
#define SONIC_DEV_CONTROL   "/home/kslee/dev/sonic_control"
#define SONIC_DEV_PORT0     "/home/kslee/dev/sonic_port0"
#define SONIC_DEV_PORT1     "/home/kslee/dev/sonic_port1"
...
static struct sonic_config_runtime_port_args default_args = {
    .port_mode = 1,
    .gen_mode = 1,
    .pkt_len = 1518,
    .batching = -1,
    ...
    .port_src = 5000,
    .port_dst = 5000,
    .mac_src = "20:10:00:c2:80:02",
    .mac_dst = "00:60:dd:45:39:05",
    .ip_src = "192.168.3.201",
    .ip_dst = "192.168.3.215",
};
